...
<div class="container-fluid"></div>
        ...
        <div class="container">
            ...
            <p class="text-center">grazie per la prenotazione.</p>
            <p class="text-center">È solo un promemoria della tua prenotazione di telemedicina con noi
il {{ $data['date'] }} alle {{ $data['starttime'] }}.</p>
